package com.cgpicaporte.springboot.webflux.app;
...
public class Spring07BootWebfluxApplication implements CommandLineRunner {
	...
	private static final Logger log = LoggerFactory.getLogger(Spring07BootWebfluxApplication.class);
		
	public static void main(String[] args) {
		SpringApplication.run(Spring07BootWebfluxApplication.class, args);
	}
